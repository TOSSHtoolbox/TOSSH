...
%   Q = data.Q; 
%   t = data.t;
%   x_Q_freq = sig_x_Q_frequency(Q,t,'no');
%   x_Q_freq = sig_x_Q_frequency(Q,t,'high');
%   x_Q_freq = sig_x_Q_frequency(Q,t,'low');
%   x_Q_freq = sig_x_Q_frequency(Q,t,'custom_low','threshold',0.2*mean(Q,'omitnan'));
%
%   References
